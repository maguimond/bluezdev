...
if [ "$BLE_ADDR" ]
    then
        ...
        gatttool -b $BLE_ADDR --char-write-req -a 0x0011 -n 0300; gatttool -b $BLE_ADDR --char-write-req -a 0x000E -n A03E8100010000000000009F; gatttool -b $BLE_ADDR --char-read --handle=0x0010 --listen
else
